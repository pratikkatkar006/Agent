    ...
    <header style={{
        ...
        <div style={{
          ...
          <div onClick={() => window.scrollTo(0, 0)} style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
            <div style={{
              ...
              <span style={{ color: '#002f34', fontSize: '20px', fontWeight: 'bold' }}>D</span>
            </div>
            <h1 style={{
              color: 'white',
              margin: 0,
      ...
      {showProfileModal && user && (
        <div style={{
          ...
          <button onClick={() => { logout(); setShowProfileModal(false); navigate('/'); 
             localStorage.removeItem('user');
             localStorage.removeItem('userData');
          }} style={btnStyle}>🚪 Logout</button>
        </div>
      )}
    </header>
  );
