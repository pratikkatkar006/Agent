...
//             fontSize: '16px'
//           }}>
//             Current Price: <span style={{ fontWeight: '600', color: '#002f34' }}>₹{property.price?.toLocaleString('en-IN')}</span>
//           </p>
//         </div>
...
//                 color: '#666'
//               }}>
//                 Minimum: ₹{(property.price * 0.9).toLocaleString('en-IN')}
//               </p>
//               <p style={{
//                 margin: 0,
//                 fontSize: '13px',
//                 color: '#666'
//               }}>
//                 Market: ₹{(property.price * 1.1).toLocaleString('en-IN')}
//               </p>
//             </div>
//           </div>
...
//             style={{
//               backgroundColor: '#23e5db',
//               backgroundImage: 'linear-gradient(to right, #23e5db, #2ff7a6)',
//               color: '#002f34',
//               border: 'none',
//               padding: '16px',
//               borderRadius: '12px',
...
//   {/* Property Detail Content - New Design */}
//   <div style={{ 
//     maxWidth: '1400px',
//     margin: '0 auto',
//     padding: '20px',
...
//                   overflow: 'hidden',
//                   cursor: 'pointer',
//                   border: selectedImageIndex === index ? '3px solid #23e5db' : '2px solid #e3e5e5',
//                   transition: 'all 0.2s',
//                   ':hover': {
