...
const Home = () => {
  ...
  <div
    ...
    style={{
      ...
      boxShadow: '0 3px 10px rgba(0, 47, 52, 0.08)',
      border: '1px solid rgba(0, 47, 52, 0.05)',
      position: 'relative',
      overflow: 'hidden',
      ':hover': {
        transform: 'translateY(-3px)',
        boxShadow: '0 8px 20px rgba(0, 47, 52, 0.12)'
      },
      '@media (min-width: 768px)': {
        borderRadius: '16px',
        padding: '30px 25px',
  ...
  >
    ...
    }}>Discover thousands of properties</p>
    <div style={{
      position: 'absolute',
      bottom: '0',
      left: '0',
  ...
  {/* Other tiles follow the same pattern with reduced sizes */}
  {/* Sell Property Tile */}
  <div
    ...
    style={{
      ...
      cursor: 'pointer',
      transition: 'all 0.3s ease-out',
      boxShadow: '0 3px 10px rgba(255, 140, 0, 0.08)',
      border: '1px solid rgba(255, 140, 0, 0.05)',
      position: 'relative',
      overflow: 'hidden',
      ':hover': {
        transform: 'translateY(-3px)',
        boxShadow: '0 8px 20px rgba(255, 140, 0, 0.12)'
      },
      '@media (min-width: 768px)': {
        borderRadius: '16px',
        padding: '30px 25px',
  ...
  >
    ...
    }}>Get the best price for your property</p>
    <div style={{
      position: 'absolute',
      bottom: '0',
      left: '0',
  ...
  <div
    ...
    style={{
      ...
      cursor: 'pointer',
      transition: 'all 0.3s ease-out',
      boxShadow: '0 3px 10px rgba(0, 114, 245, 0.08)',
      border: '1px solid rgba(0, 114, 245, 0.05)',
      position: 'relative',
      overflow: 'hidden',
      ':hover': {
        transform: 'translateY(-3px)',
        boxShadow: '0 8px 20px rgba(0, 114, 245, 0.12)'
      },
      '@media (min-width: 768px)': {
        borderRadius: '16px',
        padding: '30px 25px',
  ...
  >
    ...
    }}>Find your perfect rental home</p>
    <div style={{
      position: 'absolute',
      bottom: '0',
      left: '0',
  ...
  {/* Agents Tile */}
  <div
    onClick={() => navigate('/DraftFormsPage')}
    style={{
      background: '#d3c0a1',
      borderRadius: '12px',
      padding: '20px 15px',
      ...
      cursor: 'pointer',
      transition: 'all 0.3s ease-out',
      boxShadow: '0 3px 10px rgba(138, 43, 226, 0.08)',
      border: '1px solid rgba(138, 43, 226, 0.05)',
      position: 'relative',
      overflow: 'hidden',
      ':hover': {
        transform: 'translateY(-3px)',
        boxShadow: '0 8px 20px rgba(138, 43, 226, 0.12)'
      },
      '@media (min-width: 768px)': {
        borderRadius: '16px',
        padding: '30px 25px',
  ...
  >
    ...
    }}>Connect with trusted professionals</p>
    <div style={{
      position: 'absolute',
      bottom: '0',
      left: '0',
